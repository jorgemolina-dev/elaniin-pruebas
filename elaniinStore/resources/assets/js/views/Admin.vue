                ...
                <div class="row">
                    <div class="col-md-3">
                        <ul style="list-style-type:none">
                            <li class="active"><button class="btn" v-on:click="setComponent('main')">Dashboard</button></li>
                            <li><button class="btn" v-on:click="setComponent('orders')">Orders</button></li>
                            <li><button class="btn" v-on:click="setComponent('products')">Products</button></li>
                            <li><button class="btn" v-on:click="setComponent('users')">Users</button></li>
                        </ul>
                    </div>
                    <div class="col-md-9">
