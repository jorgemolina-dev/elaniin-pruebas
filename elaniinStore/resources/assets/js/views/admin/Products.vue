 <template>
        <div>
            <table class="table table-responsive table-striped">
                ...
                <tbody>
                    <tr v-for="(product,index) in products" :key="index" :dblclick="editingItem = product">
                        ...
                        <td @model="product.units">{{product.units}}</td>
                        <td @model="product.price">{{product.price}}</td>
                        <td @model="product.price">{{product.description}}</td>
                    </tr>
                </tbody>
            </table>
            ...
            <br>
            <button class="btn btn-primary" v-on:click="newProduct">Add New Product</button>
        </div>
    </template>
